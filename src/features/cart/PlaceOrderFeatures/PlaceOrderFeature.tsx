...
import { clearCart } from "../../../entities/Profile/model/slice/profileSlice";
...
export const PlaceOrderFeature = () => {
    ...
    const [placeOrder, { isLoading, error, isSuccess }] =
    ...
    if (error) {
        content = (
            <Alert status="error" height="200px">
                <AlertIcon />
                There was an error processing your request, Refresh the page and
                try again.
            </Alert>
        );
    }
