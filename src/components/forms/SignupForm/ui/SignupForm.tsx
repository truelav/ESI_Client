...
export const SignupForm = () => {
    ...
    if (errorSignup) {
        content = (
            <>
                <ErrorText
                    errorMessage={`An error has occured while Signing Up, please try again later`}
                />
    ...
    if (isSuccessSignup) {
        content = (
            <FormResult
                headlineText="Create account request send with Success"
                bodyText="Welcome to ESI"
            >
                <Link to="/login">
